...
### Вход: актуализация документации (ежедневно)
При чтении `_sostoyaniye.md` — проверить поле `Актуализация документации`.
Если дата не сегодня → применить правило `.claude/rules/aktualizaciya-dokumentacii.md`.
